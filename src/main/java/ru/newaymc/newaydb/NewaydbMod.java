...
@Mod("newaydb")
public class NewaydbMod {
	public static final Logger LOGGER = LogManager.getLogger(NewaydbMod.class);
	public static final String MODID = "newaydb";
